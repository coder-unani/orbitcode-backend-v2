...
import { IVideoTableFilters, IVideoTableFilterValue } from 'src/types/video';

// ----------------------------------------------------------------------

type Props = StackProps & {
  filters: IVideoTableFilters;
  onFilters: (name: string, value: IVideoTableFilterValue) => void;
  //
